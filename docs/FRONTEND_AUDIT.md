...
| `/air` | `app/air/page.tsx` | Client Component | **Water & Nutrisi (Air)**: EC gauge (1.8 mS/cm), pH bar (6.2), TDS metric (920 ppm), Tank Volume bar (450/600L), Flow Rate (12.5 L/min), 24h trend chart, 3-phase irrigation preset selector, valve toggle button. |
