...
| `MQTT_BROKER_URL`        | `string`  | `mqtts://<host>.emqxsl.com:8883`   | MQTT Broker URL (EMQX TLS; fallback: `mqtt://localhost:1883`) |
| `MQTT_GATEWAY_CLIENT_ID` | `string`  | `gateway-kebun-melon-dev-local-01` | Unique MQTT client ID (avoids staging collisions)             |
