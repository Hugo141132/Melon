...
export async function POST(request: Request, { params }: { params: { userId: string } }) {
  ...
  try {
          ...
          return NextResponse.json(
            {
              ...
              error: {
                ...
                message: 'Invalid request payload for deactivation.',
    ...
    const result = await userRepo.deactivateUser({
      ...
      return NextResponse.json(
        {
          ...
          error: {
            code: 'INTERNAL_ERROR',
            message: result.message || 'Failed to deactivate user.',
          },
          meta: { requestId },
        },
        { status: 500 }
    ...
    return NextResponse.json(
      {
        ...
        error: {
          code: 'INTERNAL_ERROR',
          message: 'An unexpected internal error occurred while deactivating user.',
        },
        meta: { requestId },
      },
      { status: 500 }
