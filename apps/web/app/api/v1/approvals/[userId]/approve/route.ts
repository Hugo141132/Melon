      ...
      return NextResponse.json(
        {
          ...
          error: {
            code: 'FORBIDDEN',
            message: 'Owner access required to approve admin registrations.',
          },
          meta: { requestId },
        },
        { status: 403 }
          ...
          return NextResponse.json(
            {
              ...
              error: {
                ...
                message: 'Catatan persetujuan (decisionNote) maksimal 1000 karakter.',
              },
              meta: { requestId },
            },
            { status: 422 }
    ...
    return NextResponse.json(
      {
        ...
        error: {
          code: 'INTERNAL_ERROR',
          message: 'An unexpected internal error occurred during account approval.',
        },
        meta: { requestId },
      },
      { status: 500 }
