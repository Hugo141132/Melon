...
import { Home, Leaf, Droplets, Bell } from 'lucide-react';
      ...
      {navItems.map(({ href, label, Icon }) => {
        ...
        return (
          <Link
            ...
            href={href}
            className={cn(
              'flex flex-col items-center justify-center gap-0.5 px-5 py-1 rounded-full transition-all duration-200 active:scale-90 cursor-pointer',
              isActive
          ...
          >
            ...
            />
            <span
              className={cn('text-[12px] leading-4 font-medium', isActive ? 'font-semibold' : '')}
            >
              {label}
            </span>
          </Link>
